...
/*
 * 일반저긍로 서비스 레이어는 인터페이스와 클래스를 함께 사용한다.
...
public class BookServiceImpl implements IBookService {
	 ...
	 * 클래스의 이름이 Impl로 끝나는 클래스들이 있는데 implements의 약자로 관습에 따른다.
	 * Impl이 붙고 안붙고에 따라 클래스인지 인터페이스인지 구변하기 쉽다.
	 */
	@Inject
