				...
				<div class="">
					<div class="card-body">
						<form method="post" action="/free/insert.do" id="freeForm" class="form-horizontal">
							<c:if test="${status eq 'u' }">
								<input type="hidden" name="freeNo" id="number" value="${free.freeNo }">
							</c:if>
							<div class="form-group row">
								<label class="col-sm-2 control-label" >제목</label>
								<div class="col-sm-10">
									<input name="freeTitle" id="freeTitle" type="text" class="form-control" value="${free.freeTitle }" placeholder="제목을 입력해주세요.">
								</div>
								<font color="red" style="font-size:14px;">${errors.freTitle }</font>
							</div>
							...
							<font color="red" style="font-size:14px;">${errors.freeContent }</font>
							<div class="form-group row mt-4">
...
$(function() {
   ...
   cancelBtn.on("click", function() {
		let freeNo = $("#number").val();
		location.href = "/free/detail.do?freeNo="+freeNo;
	});
