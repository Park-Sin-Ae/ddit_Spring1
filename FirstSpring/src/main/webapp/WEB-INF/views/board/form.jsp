            ...
            <div class="">
               <div class="card-body">
                  <form method="post" action="/board/insert.do" id="boardForm" class="form-horizontal">
                     <c:if test="${status eq 'u' }">
                        <input type="hidden" name="boNo" id="number" value="${board.boNo }"/>
                     </c:if>
                     <div class="form-group row">
                        ...
                        <font color="red" style="font-size:14px;">${errors.boTitle }</font>
                     </div>
                     ...
                     <font color="red" style="font-size:14px;">${errors.boContent }</font>
                     <div class="form-group row mt-4">
