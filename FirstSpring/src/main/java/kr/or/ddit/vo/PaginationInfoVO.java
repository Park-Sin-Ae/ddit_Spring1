...
public class PaginationInfoVO<T> {
	...
	public void setCurrentPage(int currentPage) {
		...
		// blockSize * blockSize 1,2,3,4,5... 페이지마다 싨후계산이 아닌 정수 계산을 이용해 endPage를 구한다.
	...
	public String getPagingHTML() {
		...
		// 넘어가야할 페이지가 존재하지 않는 상태라면 마지막 페이지가 포함되어 있는 block 영역이므로 totalPage만큼 반복됨.
